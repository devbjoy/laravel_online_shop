    ...
    <form action="{{ route('products.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="sort_description" id="sort_description" cols="30" rows="10" class="summernote form-control" placeholder="Sort Description">
                                        {{ old('sort_description') }}
                                    </textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="shipping_returns" id="shipping_returns" cols="30" rows="10" class="summernote form-control" placeholder="Shipping Returns">
                                        {{ old('description') }}
                                    </textarea>
                                </div>
                            </div>                                            
                ...
                <div class="card mb-3 p-3">product_image_lg
                    <label for="image_lg">Product Image Lg</label>
                ...
                <div class="card mb-3 p-3">product_image_sm
                    <label for="image_sm">Product Image Sm</label>
                    <input type="file" name="image_sm" class="form-control @error('image_sm')is-invalid @enderror" accept="image\*"> 
                    <span class="text-danger">@error('image_sm') {{ $message }} @enderror</span>                                                                
                </div>
                <div class="card mb-3">
                    <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <input class="custom-control-input" type="checkbox" id="track_qty" name="track_qty" checked value="Yes" value="{{ old('track_qty') }}">                    
                                        <label for="track_qty" class="custom-control-label">Track Quantity</label>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <input type="number" min="0" name="qty" id="qty" class="form-control @error('qty')is-invalid @enderror" placeholder="Qty" value="{{ old('qty') }}">
