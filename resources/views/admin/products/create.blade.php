                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="card mb-3 p-3">
                                    ...
                                    <input type="file" name="image_lg" class="form-control @error('image_lg')is-invalid @enderror" accept="image\*"  value="{{ old('image_lg') }}"> 
                                    <span class="text-danger">@error('image_lg') {{ $message }} @enderror</span>                                                                
                                </div>
                                <div class="card mb-3 p-3">
                                    <label for="product_image">Product Image Sm</label>
                                    <input type="file" name="image_sm" class="form-control @error('image_sm')is-invalid @enderror" accept="image\*"  value="{{ old('image_sm') }}"> 
