            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div class="card-title">
                        <a href="{{ route('discount.index') }}" class="btn btn-default btn-sm">Reset</a>
                    </div>
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            @if($discounts->isNotEmpty())
                                ...
                                <td>{{ $discount->max_uses_user }}</td>
                                <td>{{ (!empty($discount->starts_at)) ? $discount->starts_at : '' }}</td>
                                <td>{{ (!empty($discount->expires_at)) ? $discount->expires_at : '' }}</td>
                                <td>
                            ...
                            @else
                                <tr>
                                    <td colspan="8" class="text-center text-bold">Discount coupon is Empty</td>
                                </tr>
                            @endif
