...
<section class="content">
    {{-- @error($errors->any())
            {{ $message }}
        @enderror --}}
    <form action="" method="post" enctype="multipart/form-data" id="updateDiscountFrom">
        <!-- Default box -->
        ...
        <div class="row">
            <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="code" id="code" class="form-control" placeholder="Discount Code" value="{{ $discount->code }}">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-12">
                ...
                <div class="card mb-3 p-3">
                    ...
                    <input type="number" name="max_uses_user" id="max_uses_user" class="form-control" placeholder="Max Uses User" value="{{ $discount->max_uses_user }}">                                                             
                </div>               
            </div>
            <div class="col-md-4"> 
                <div class="card mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="min_amount" id="min_amount" class="form-control" placeholder="min_amount"  value="{{ $discount->min_amount }}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="discount_amount">Discount Amount</label>
                                    <input type="number" name="discount_amount" id="discount_amount" class="form-control" placeholder="discount_amount"  value="{{ $discount->discount_amount }}">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input autocomplete="off" type="text" name="starts_at" id="starts_at" class="form-control" placeholder="starts_at" value="{{ $discount->starts_at }}">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input autocomplete="off" type="text" name="expires_at" id="expires_at" class="form-control" placeholder="expires_at" value="{{ $discount->expires_at }}">
                                    <p></p>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $('#updateDiscountFrom').on('submit',function(event){
