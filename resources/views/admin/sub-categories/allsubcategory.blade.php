						...
						<div class="card">
							...
							<div class="card-header">
								<div class="card-title">
									<a href="{{ route('subcategory.index') }}" class="btn btn-default btn-sm">Reset</a>
								</div>
								...
								<table class="table table-hover text-nowrap">
									...
									<tbody>
										@if($data->isNotEmpty())
											...
											<td>
												<a href="{{ route('subcategory.edit',$category->id) }}" class="btn btn-secondary">
										...
										@else
											<tr>
												<td colspan="7" class="text-center text-bold">This Sub Category is Empty</td>
											</tr>
										@endif
