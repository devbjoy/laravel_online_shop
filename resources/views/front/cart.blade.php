                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <img  src="{{ asset('storage/'.$item->options->productImage) }}" alt="Image">
                                        @else
                                ...
                                <td>
                                    <button class="btn btn-sm btn-danger" onclick="deleteCartTtem('{{ $item->rowId }}')"><i class="fa fa-times"></i></button>
                                </td>
                            </tr>
                            @endforeach                                    
                        </tbody>
            ...
            <div class="col-md-12">
                <div class="card bg-danger">
                    <div class="card-body flex justify-content-center">
                        <h4 class="text-center text-white">Your Cart Is Empty !</h4>
                    </div>
                </div>
            </div>
            @endif
